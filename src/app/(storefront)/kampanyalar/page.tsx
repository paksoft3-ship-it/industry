...
const campaigns = [
  { id: "1", title: "CNC Router Kombin Setleri", description: "Hazır CNC çözümleri ile projenize hemen başlayın", discount: 15, image: "/images/placeholder.jpg" },
  { id: "2", title: "Step Motor Paketleri", description: "Motor + Sürücü paketlerinde özel fiyatlar", discount: 10, image: "/images/placeholder.jpg" },
];
    ...
    <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 py-8">
      ...
      {discountedProducts.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Products would render here when available */}
        </div>
      ) : (
        <div className="text-center py-20">
          <MaterialIcon icon="inventory_2" className="text-6xl text-gray-300 mb-4" />
          <p className="text-gray-500">İndirimli ürünler yakında eklenecektir.</p>
        </div>
      )}
    </div>
  );
