...
const categories = [
  ...
  { id: "elektronik", name: "Elektronik", subtitle: "Kontrol Sistemleri", icon: "memory", image: "", productCount: 35 },
  { id: "spindle-motorlar", name: "Spindle Motor", subtitle: "İşleme Motorları", icon: "speed", image: "", productCount: 12 },
  { id: "lineer-ray-arabalar", name: "Lineer Ray", subtitle: "Hassas Hareket", icon: "linear_scale", image: "", productCount: 30 },
  { id: "cnc-router", name: "CNC Router", subtitle: "Komple Çözümler", icon: "router", image: "", productCount: 8 },
  { id: "step-motor-surucu", name: "Step Motor Sürücü", subtitle: "Hareket Kontrolü", icon: "settings_input_component", image: "", productCount: 20 },
];
